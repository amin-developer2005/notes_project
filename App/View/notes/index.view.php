...
?>
    ...
    <div class="max-w-7xl py-20 space-y-9 sm:px-6 lg:px-8">
        ...
        <?php
            if (! $notes) {
                ?>
            <h1 class="text-bold text-xl mb-9">You have not created any notes.</h1>
        <?php
            } else {
                foreach ($notes as $note) {
                ?>
<!---->
<!--                <div class="flex flex-col md:py-14 gap-x-13 bg-white/5 hover:bg-white/15 rounded-xl border border-transparent hover:border-blue-700 transition-colors duration-300 group cursor-pointer">-->
<!--                    <a href="--><?php //= Url::load('') . $note->id ?><!--" class="text-xl font-bold text-white group-hover:text-blue-600">--><?php //= $note->title ?><!--</a>-->
<!--                    <p class="text-l text-white">--><?php //= $note->body ?><!--</p>-->
<!--                </div>-->
<!---->
<!---->
                    ...
                    <div class="max-w-7xl sm:px-6 lg:px-9 flex md:py-18 p-10-center bg-white/15 hover:bg-white/10 rounded-xl border border-transparent hover:border-blue-700 transition-colors duration-300 group cursor-pointer">
                        ...
                        <div class="gap-x-4 flex items-center md:mb-35">
                            <a href="<?= Url::load('/note/show?id=') . $note->id ?>" class="<?= $btnClasses ?>">View</a>
                        </div>
